...
import pytest
from arctrl import ARC, ArcInvestigation, ArcStudy, ArcAssay # type: ignore[import]

from middleware.inspire_to_arc.mapper import InspireMapper
from middleware.inspire_to_arc.harvester import InspireRecord, Contact, ResourceIdentifier
...
def test_map_study(mapper: InspireMapper, sample_record: InspireRecord) -> None:
    ...
    assert "Lineage: Processed using algorithm X" in study.Description
